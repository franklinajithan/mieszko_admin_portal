...
const notifications: NotificationItem[] = [
  {
    ...
    text: (
      <React.Fragment>
        <strong>Dominador Manuel</strong> and <strong>100 other people</strong> reacted to your comment "Tell your partner that..."
      </React.Fragment>
    ),
    date: "Aug 20 08:55am",
    status: "online"
  },
  {
    ...
    text: (
      <React.Fragment>
        <strong>Angela Ighot</strong> tagged you and <strong>9 others</strong> in a post.
      </React.Fragment>
    ),
    date: "Aug 18 10:30am",
    status: "online"
  },
  {
    ...
    text: (
      <React.Fragment>
        New listings were added that match your search alert <strong>house for rent</strong>
      </React.Fragment>
    ),
    date: "Aug 15 08:10pm",
    status: ""
  ...
  },
  {
    ...
    text: (
      <React.Fragment>
        <strong>Dyanne Aceron</strong> reacted to your post <strong>King of the Bed</strong>
      </React.Fragment>
    ),
    date: "Aug 10 05:30am",
    status: "online"
