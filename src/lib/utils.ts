...
export const editProductFormSchema = z.object({
  ...
  translatedIngredients: z.string().nullable().optional(),
  allergicDetails: z.string(),
  translatedAllergicDetails: z.string().nullable().optional(),
  ...
  selfNo: z.string().nullable().optional(), // Add .optional() if the field is not required
  inventory: z.string().nullable().optional(),
  qtyOnPurchaseOrder: z.string().nullable().optional(),
  stockOutWarning: z.string().nullable().optional(),
  standardCost: z.number().optional(), // Use z.number() for numerical fields
  unitCost: z.number().optional(),
  reorderingPolicy: z.string().nullable().optional(),
  safetyLeadTime: z.string().nullable().optional(),
  safetyStockQuantity: z.string().nullable().optional(),
  includeInventory: z.string().nullable().optional(),
  reschedulePeriod: z.string().nullable().optional(),
  reorderQuantity: z.string().nullable().optional(),
  maximumInventory: z.string().nullable().optional(),
  minimumOrderQuantity: z.string().nullable().optional(),
  maximumOrderQuantity: z.string().nullable().optional(),
  orderMultiple: z.string().nullable().optional(),
  baseUnitOfMeasure: z.string().nullable().optional(),
  caseSize: z.string().nullable().optional(),
  pcsPerPallet: z.string().nullable().optional(),
  pcsPerLayers: z.string().nullable().optional(),
  itemCategoryCode: z.string().nullable().optional(), // New field
  retailPrice: z.string().nullable().optional(), // Adjusted based on type in the form
  promotionalRetail: z.string().nullable().optional(), // Adjusted based on type in the form
  margin: z.string().nullable().optional(), // Adjusted based on type in the form
  vat: z.object({
    vatId: z.string(),
    vatCode: z.string(),
    vatRate: z.number(),
