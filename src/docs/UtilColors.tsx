...
<p className="text-dark">Seeing a spider in my room isn't scary. It's scary when it disappears.</p>`}</code></pre>
          ...
          <Card className="card-example">
            <Card.Body>
              <div className="demo-text">
                <a className="link-primary">Seeing a spider in my room isn't scary. It's scary when it disappears.</a>
                <a className="link-secondary">Seeing a spider in my room isn't scary. It's scary when it disappears.</a>
                <a className="link-success">Seeing a spider in my room isn't scary. It's scary when it disappears.</a>
                <a className="link-warning">Seeing a spider in my room isn't scary. It's scary when it disappears.</a>
                <a className="link-danger">Seeing a spider in my room isn't scary. It's scary when it disappears.</a>
                <a className="link-info">Seeing a spider in my room isn't scary. It's scary when it disappears.</a>
                <a className="link-dark">Seeing a spider in my room isn't scary. It's scary when it disappears.</a>
              </div>
            </Card.Body>
            <Card.Footer>
