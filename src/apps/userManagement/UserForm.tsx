                            ...
                            <CardContent>
                                <div className="flex w-full gap-3">
                                    ...
                                    <div className="grid grid-cols-1 w-1/6 mt-4">
                                        <div
                                            className="col-span-1 flex flex-col justify-center items-center h-full bg-gradient-to-br from-cyan-700 via-cyan-800 to-cyan-700 p-6 rounded-lg"
                                            role="region"
                                            aria-labelledby="profile-upload-label"
                                        >
                                            <h2 id="profile-upload-label" className="sr-only">Profile Picture Upload</h2>
                                    ...
                                    <div className="grid grid-cols-1 w-5/6 md:grid-cols-2 lg:grid-cols-5 gap-3 mt-4">
                                        {/* Input Fields with Validation and Accessibility */}
                                        <InputField control={control} label="Employee ID" name="employeeId" type="text" placeholder="Enter your ID" aria-required="true" />
                                        <InputField control={control} label="First Name" name="firstName" type="text" placeholder="Enter your first name" aria-required="true" />
                                        <InputField control={control} label="Last Name" name="lastName" type="text" placeholder="Enter your last name" />
                                        <CalendarInput control={control} label="Date of Birth" name="dob" aria-required="true" />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-3 mt-4">
                                    <InputField control={control} label="Username" name="username" type="text" placeholder="Enter your username" />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-3 mt-4">
                                    ...
                                    <CheckboxField control={control} id="hasAccessToBackOffice" label="Access to Back Office" name="hasAccessToBackOffice" />
                                ...
                                <div className="flex justify-end space-x-4 mt-2 pr-4">
                                    <button className="btn-zinc" aria-label="Cancel">
                                        Cancel
                                    </button>
                                    <Button
                                        type="submit"
