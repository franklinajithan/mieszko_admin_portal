...
const ProductList = ({ title, icon }: any) => {
  ...
  const [departmentOptions, setDepartmentOptions] = useState(
    exampleDepartmentOptions
  );
  const [supplierOptions, setSupplierOptions] = useState(
    exampleSupplierOptions
  );
  const [barcodePluOptions, setBarcodePluOptions] = useState(
    exampleBarcodePluOptions
  );
  const [itemCodeOptions, setItemCodeOptions] = useState(
    exampleItemCodeOptions
  );
  const [itemNameOptions, setItemNameOptions] = useState(
    exampleItemNameOptions
  );
  ...
  const [priceMarkedItemOptions, setPriceMarkedItemOptions] = useState(
    examplePriceMarkedItemOptions
  );
  const [caseSizeOptions, setCaseSizeOptions] = useState(
    exampleCaseSizeOptions
  );
  const [fastestDeliveryOptions, setFastestDeliveryOptions] = useState(
    exampleFastestDeliveryOptions
  );
  ...
  const columns: GridColDef[] = [
    ...
    {
      field: "translatedIngredients",
      headerName: "Translated Ingredients",
      flex: 1,
    },
    { field: "allergicDetails", headerName: "Allergic Details", flex: 1 },
    {
      field: "translatedAllergicDetails",
      headerName: "Translated Allergic Details",
      flex: 1,
    },
                ...
                <Form {...form}>
                  ...
                  >
                    <div className="grid w-full grid-cols-5 gap-4">
                      ...
                      <SelectField
                        control={form.control}
                        label="Price Marked Item"
                        name="priceMarkedItem"
                        options={priceMarkedItemOptions}
                      />
                      <SelectField
                        control={form.control}
                        label="Case Size"
                      ...
                      <SelectField
                        ...
                        options={fastestDeliveryOptions}
                      />
                    </div>

                    <hr className="border-t border-zinc-300 " />
                    <div className="flex justify-end space-x-4  mt-2 pr-4">
                      <button className="btn-zinc">Reset</button>
                      <Button
                        type="submit"
                        disabled={isLoading}
                        className="btn-cyan"
