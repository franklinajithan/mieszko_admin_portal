...
const FillScanList = ({ title, icon }: any) => {
  ...
  const onClickAddFillScanList = () => {
    navigate(`/sale/fill-scan-list-details`);
  };
              ...
              <CardContent>
                <div>
                  <div className="flex justify-start space-x-4  mt-2 pr-4">
                    <Button type="submit" className="btn-cyan" onClick={onClickAddFillScanList}>
                      Fill Scan List
                    </Button>
                  </div>
